...
<section id="samsung-process" class="samsung-process-section">
  <div class="container-fluid samsung-process-wrap">
    ...
    <h2 class="samsung-process-title"><?php echo htmlspecialchars($process['title'] ?? 'Sell Your iPhone in 3 Easy Steps'); ?></h2>
    <p class="samsung-process-subtitle"><?php echo htmlspecialchars($process['subtitle'] ?? 'Our simple and transparent process makes selling your iPhone quick, safe, and profitable.'); ?></p>
