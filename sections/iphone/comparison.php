...
$rows = home_rows($conn, 'iphone_comparison_rows');
...
<section id="samsung-comparison" class="samsung-comparison-section">
  <div class="container-fluid samsung-comparison-wrap">
    ...
    <p class="samsung-comparison-text"><?php echo htmlspecialchars($cmp['text'] ?? 'See why thousands of Dubai iPhone owners choose our doorstep service over retail shops, classified boards, carrier trade-ins, and store trade-ins.'); ?></p>
