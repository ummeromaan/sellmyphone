...
$cards = home_rows($conn, 'iphone_series_cards');
$series_link = $series['button_link'] ?? 'apple.php#apple';
?>
    ...
    <div class="row align-items-stretch g-4">
      ...
      <div class="col-lg-4">
        <div class="samsung-series-left">
          <span class="samsung-series-tag"><?php echo htmlspecialchars($series['tag_text'] ?? 'IPHONE BUYBACK'); ?></span>
          <h2 class="samsung-series-title-main"><?php echo htmlspecialchars($series['title'] ?? 'We Buy All Latest iPhones'); ?></h2>
          <p class="samsung-series-text"><?php echo htmlspecialchars($series['text'] ?? 'From the newest Pro Max to older favorites - we buy all iPhone models in any condition at the best price in Dubai.'); ?></p>
          ...
          <a href="<?php echo htmlspecialchars($series_link); ?>" class="samsung-series-btn">
            <?php echo htmlspecialchars($series['button_text'] ?? 'View All iPhone Models'); ?> <i class="fa-solid fa-arrow-right"></i>
          </a>
        </div>
      </div>
