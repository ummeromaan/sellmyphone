...
$cards = home_rows($conn, 'samsung_policy_cards');
?>
<section class="sm-policy-section">
  <div class="container-fluid samsung-policy-wrap">
    ...
    <h2 class="sm-policy-title"><?php echo htmlspecialchars($policy['title'] ?? 'Samsung Models & Conditions We Buy'); ?> <span class="highlight">in Dubai</span></h2>

    <p class="sm-policy-subtitle"><?php echo htmlspecialchars($policy['subtitle'] ?? "Transparent pricing starts with clear standards. Here's our exact criteria for purchasing Samsung phones in Dubai, so you know exactly what to expect before you request a quote — no guesswork, no last-minute price drops."); ?></p>
    ...
    <div class="sm-policy-banner">
      <div class="sm-policy-banner-item">
        ...
        <div>
          <p class="sm-policy-banner-text"><?php echo htmlspecialchars($policy['banner_text'] ?? 'We offer the best value for genuine Samsung devices in the best possible condition, backed by a fair, upfront evaluation every single time.'); ?></p>
