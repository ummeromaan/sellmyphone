<?php
$page_title = "Sell Your Samsung Phone in UAE | Instant Cash Offer - SellMyPhone";
$meta_description = "Sell your Samsung phone for the best price in UAE. Get instant valuation for Galaxy S series, Note series and more, with free pickup and fast payment.";
$meta_keywords = "sell Samsung UAE, sell Samsung Dubai, Samsung buyback, Galaxy cash offer";
?>
...
<!-- Price stepper + calculator share ONE calc widget, same as the homepage
     ...
     (Samsung) since this is the dedicated Samsung page, so step 1 shows "done" and
     step 2 (Model) starts active. Synced with the tabs via the script below. -->
<section class="brand-section pt-5">
  <div class="container calc-widget calc-widget-plain" id="calc-standalone">
    ...
    <div class="price-stepper" id="price-stepper-standalone">
        ...
        <div class="step-item done" data-step="1">
            ...
            <span class="step-sublabel">Samsung</span>
        </div>
    ...
    <?php $standalone_page = true; include 'samsung-content.php'; ?>
