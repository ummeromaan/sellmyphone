...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action'])) {
    ...
    switch ($action) {
        ...
        // ---------- HERO ----------
        case 'update_hero':
            home_save_single($conn, 'samsung_hero',
        ...
        // ---------- BRAND CARD ----------
        case 'update_brand':
            home_save_single($conn, 'samsung_brand',
        ...
        case 'add_brand_feature':
            home_row_add($conn, 'samsung_brand_features', ['icon', 'title', 'subtitle', 'sort_order']);
            break;
        case 'update_brand_feature':
            home_row_update($conn, 'samsung_brand_features', $_POST['id'], ['icon', 'title', 'subtitle', 'sort_order']);
            break;
        case 'delete_brand_feature':
            home_row_delete($conn, 'samsung_brand_features', $_POST['id']);
            break;

        // ---------- SERIES / MODELS ----------
        case 'update_series':
            home_save_single($conn, 'samsung_series',
                ['tag_text', 'title', 'text', 'button_text', 'button_link']);
            break;
        case 'add_series_card':
            home_row_add($conn, 'samsung_series_cards', ['icon', 'card_title', 'card_title_paren', 'desc', 'models', 'sort_order']);
            break;
        case 'update_series_card':
            home_row_update($conn, 'samsung_series_cards', $_POST['id'], ['icon', 'card_title', 'card_title_paren', 'desc', 'models', 'sort_order']);
            break;
        case 'delete_series_card':
            home_row_delete($conn, 'samsung_series_cards', $_POST['id']);
            break;

        // ---------- PROCESS STEPS ----------
        case 'update_process':
            home_save_single($conn, 'samsung_process', ['tag_text', 'title', 'subtitle']);
            break;
        case 'add_process_step':
            home_row_add($conn, 'samsung_process_steps', ['step_label', 'card_title', 'icon', 'detail_title', 'detail_desc', 'sort_order']);
            break;
        case 'update_process_step':
            home_row_update($conn, 'samsung_process_steps', $_POST['id'], ['step_label', 'card_title', 'icon', 'detail_title', 'detail_desc', 'sort_order']);
            break;
        case 'delete_process_step':
            home_row_delete($conn, 'samsung_process_steps', $_POST['id']);
            break;

        // ---------- LOCATION / COVERAGE ----------
        case 'update_location':
            home_save_single($conn, 'samsung_location', ['badge_text', 'heading', 'text']);
            break;
        case 'add_location_area':
            home_row_add($conn, 'samsung_location_areas', ['area_name', 'sort_order']);
            break;
        case 'update_location_area':
            home_row_update($conn, 'samsung_location_areas', $_POST['id'], ['area_name', 'sort_order']);
            break;
        case 'delete_location_area':
            home_row_delete($conn, 'samsung_location_areas', $_POST['id']);
            break;

        // ---------- COMPARISON TABLE ----------
        case 'update_comparison':
            home_save_single($conn, 'samsung_comparison',
                ['brand_name', 'badge_text', 'heading', 'text', 'col2_header', 'col3_header', 'col4_header']);
            break;
        case 'add_comparison_row':
            home_row_add($conn, 'samsung_comparison_rows', ['feature', 'col1_value', 'col2_value', 'col3_value', 'col4_value', 'sort_order']);
            break;
        case 'update_comparison_row':
            home_row_update($conn, 'samsung_comparison_rows', $_POST['id'], ['feature', 'col1_value', 'col2_value', 'col3_value', 'col4_value', 'sort_order']);
            break;
        case 'delete_comparison_row':
            home_row_delete($conn, 'samsung_comparison_rows', $_POST['id']);
            break;

        // ---------- ACCEPTANCE POLICY ----------
        case 'update_policy':
            home_save_single($conn, 'samsung_policy',
                ['tag_text', 'title', 'subtitle', 'banner_text', 'banner_highlight', 'banner_title', 'banner_sub']);
            break;
        case 'add_policy_card':
            home_row_add($conn, 'samsung_policy_cards', ['icon', 'title', 'list_type', 'items', 'sort_order']);
            break;
        case 'update_policy_card':
            home_row_update($conn, 'samsung_policy_cards', $_POST['id'], ['icon', 'title', 'list_type', 'items', 'sort_order']);
            break;
        case 'delete_policy_card':
            home_row_delete($conn, 'samsung_policy_cards', $_POST['id']);
            break;

        // ---------- FAQ ----------
        case 'update_faq_header':
            home_save_single($conn, 'samsung_faq_header', ['tag_text', 'title']);
            break;
        case 'add_faq':
            home_row_add($conn, 'samsung_faq', ['question', 'answer', 'column_no', 'sort_order']);
            break;
        case 'update_faq':
            home_row_update($conn, 'samsung_faq', $_POST['id'], ['question', 'answer', 'column_no', 'sort_order']);
            break;
        case 'delete_faq':
            home_row_delete($conn, 'samsung_faq', $_POST['id']);
            break;

        // ---------- CTA ----------
        case 'update_cta':
            home_save_single($conn, 'samsung_cta',
    ...
    header("Location: sell-samsung-content.php?tab=" . urlencode($tab));
    exit();
}
...
$brand_feats = home_rows($conn, 'samsung_brand_features');

$series      = home_single($conn, 'samsung_series');
$series_cards = home_rows($conn, 'samsung_series_cards');

$process     = home_single($conn, 'samsung_process');
$proc_steps  = home_rows($conn, 'samsung_process_steps');

$loc         = home_single($conn, 'samsung_location');
$loc_areas   = home_rows($conn, 'samsung_location_areas');

$cmp         = home_single($conn, 'samsung_comparison');
$cmp_rows    = home_rows($conn, 'samsung_comparison_rows');

$policy      = home_single($conn, 'samsung_policy');
$policy_cards = home_rows($conn, 'samsung_policy_cards');

$faqh        = home_single($conn, 'samsung_faq_header');
$faq_all     = home_rows($conn, 'samsung_faq', 'column_no ASC, sort_order ASC, id ASC');

$cta         = home_single($conn, 'samsung_cta');
...
<nav class="navbar navbar-expand-lg">
   <div class="container-fluid">
        <a class="navbar-brand fw-bold text-dark fs-3" href="#">Sell Samsung Page Content</a>
    </div>
</nav><hr class="m-0">
    ...
    <?php if ($tab == 'hero'): ?>
        ...
        <div class="ct-panel-header">
            <div>
                ...
                <p class="ct-panel-sub">The top banner visitors see first on the Sell Samsung page.</p>
            </div>
        </div>
            ...
            <div class="hc-card">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="badge_text" value="<?php echo htmlspecialchars($hero['badge_text'] ?? 'SAMSUNG BUYBACK IN DUBAI'); ?>">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-bold">Heading (before highlight)</label>
                        <input type="text" class="form-control" name="title_pre" value="<?php echo htmlspecialchars($hero['title_pre'] ?? 'Sell Your Samsung'); ?>">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="button_link" value="<?php echo htmlspecialchars($hero['button_link'] ?? '#samsung'); ?>">
                    </div>
                    <div class="col-md-4">
    ...
    <?php elseif ($tab == 'brand'): ?>
        ...
        <div class="ct-panel-header">
            <div>
                ...
                <p class="ct-panel-sub">The "We Buy All Latest Samsungs" quote card, right after the hero.</p>
            </div>
        </div>
        ...
        <form method="POST" class="hc-card">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" class="form-control" name="right_text" value="<?php echo htmlspecialchars($brand['right_text'] ?? 'Select Samsung to get an instant price for your phone.'); ?>">
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="heading_highlight" value="<?php echo htmlspecialchars($brand['heading_highlight'] ?? 'Samsung'); ?>">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" name="subtext" value="<?php echo htmlspecialchars($brand['subtext'] ?? 'Get an instant, no-obligation price for your Samsung and turn it into cash today.'); ?>">
                </div>

                <div class="col-md-6">
                    <label class="form-label fw-bold">Left Card - Title</label>
                    <input type="text" class="form-control" name="left_title" value="<?php echo htmlspecialchars($brand['left_title'] ?? 'We Buy All Latest Samsung Phones'); ?>">
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-bold">Left Card - Text</label>
                    <input type="text" class="form-control" name="left_text" value="<?php echo htmlspecialchars($brand['left_text'] ?? 'Sell your Samsung phone in Dubai and get the best value instantly. Quick, easy and 100% secure process.'); ?>">
                </div>

                <div class="col-md-4">
                    <label class="form-label fw-bold">Right Card - Badge</label>
                    <input type="text" class="form-control" name="right_badge" value="<?php echo htmlspecialchars($brand['right_badge'] ?? 'SELL SAMSUNG'); ?>">
                </div>
                <div class="col-md-4">
                    <label class="form-label fw-bold">Right Card - Logo Text</label>
                    <input type="text" class="form-control" name="right_logo_text" value="<?php echo htmlspecialchars($brand['right_logo_text'] ?? 'SAMSUNG'); ?>">
                </div>
                <div class="col-md-4">
                    <label class="form-label fw-bold">Right Card - Button Link</label>
                    <input type="text" class="form-control" name="button_link" value="<?php echo htmlspecialchars($brand['button_link'] ?? 'samsung.php#samsung'); ?>">
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-bold">Right Card - Button Text</label>
                    <input type="text" class="form-control" name="button_text" value="<?php echo htmlspecialchars($brand['button_text'] ?? 'Select Samsung'); ?>">
                </div>
            </div>
    ...
    <?php elseif ($tab == 'series'): ?>
        ...
        <div class="ct-panel-header">
            <div>
                ...
                <p class="ct-panel-sub">The "We Buy All Latest Samsungs" grid with model cards.</p>
            </div>
        </div>
        ...
        <form method="POST" class="hc-card">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="tag_text" value="<?php echo htmlspecialchars($series['tag_text'] ?? 'SAMSUNG BUYBACK'); ?>">
                </div>
                <div class="col-md-8">
                    <label class="form-label fw-bold">Title</label>
                    <input type="text" class="form-control" name="title" value="<?php echo htmlspecialchars($series['title'] ?? 'We Buy All Latest Samsung Phones'); ?>">
                </div>
                <div class="col-12">
                ...
                <div class="col-md-8">
                    <label class="form-label fw-bold">Button Text</label>
                    <input type="text" class="form-control" name="button_text" value="<?php echo htmlspecialchars($series['button_text'] ?? 'View All Samsung Models'); ?>">
                </div>
                <div class="col-md-4">
                    <label class="form-label fw-bold">Button Link</label>
                    <input type="text" class="form-control" name="button_link" value="<?php echo htmlspecialchars($series['button_link'] ?? 'samsung.php#samsung'); ?>">
                </div>
            </div>
    ...
    <?php elseif ($tab == 'process'): ?>
        ...
        <div class="ct-panel-header">
            <div>
                ...
                <p class="ct-panel-sub">The "Sell Your Samsung in 3 Easy Steps" interactive stepper.</p>
            </div>
        </div>
        ...
        <form method="POST" class="hc-card">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-8">
                    <label class="form-label fw-bold">Title</label>
                    <input type="text" class="form-control" name="title" value="<?php echo htmlspecialchars($process['title'] ?? 'Sell Your Samsung in 3 Easy Steps'); ?>">
                </div>
                <div class="col-12">
                    <label class="form-label fw-bold">Subtitle</label>
    ...
    <?php elseif ($tab == 'policy'): ?>
        ...
        <div class="ct-panel-header">
            <div>
                ...
                <p class="ct-panel-sub">"Samsung Models & Conditions We Buy" cards + trust banner.</p>
            </div>
        </div>
        ...
        <form method="POST" class="hc-card">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" class="form-control" name="title" value="<?php echo htmlspecialchars($policy['title'] ?? 'Samsung Models & Conditions We Buy'); ?>">
                </div>
                <div class="col-12">
                    <label class="form-label fw-bold">Subtitle</label>
        ...
        <form method="POST" class="hc-card">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" class="form-control" name="heading" value="<?php echo htmlspecialchars($cta['heading'] ?? "Your Samsung Won't Get Any Newer.<br>Sell It Before the Price Drops."); ?>">
                </div>
                <div class="col-12">
                    <label class="form-label fw-bold">Text</label>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="card_heading" value="<?php echo htmlspecialchars($cta['card_heading'] ?? 'Get an Instant Quote for Your Samsung'); ?>">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" name="primary_btn_link" value="<?php echo htmlspecialchars($cta['primary_btn_link'] ?? 'samsung.php#samsung'); ?>">
                </div>
                <div class="col-md-6">
